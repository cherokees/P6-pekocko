...
router.get('/', auth, stuffCtrl.getAllSauces); // Renvoie le tableau de toutes les sauces dans la base de données
...
router.get('/:id', auth, stuffCtrl.getOneSauce); // Renvoie la sauce avec l'ID fourni
...
router.delete('/:id', auth, stuffCtrl.deleteSauce); // Supprime la sauce avec l'ID fourni.
